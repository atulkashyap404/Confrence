...
const SPEAKERS = [
  ...
  {
    id: 12,
    name: "Dr. Bhuvneshwari B",
    role: "Professor",
    company: "Indian Institute of Technology (IIT) BHU",
    bio: "",
    image: "/speakers/Dr. Bhuvneshwari B.jpg",
    category: "",
    featured: false,
    socials: {
      twitter: "#",
  ...
  {
    id: 15,
    name: "Prof. Deeksha Katyal",
    role: "Professor",
    company: "Guru Gobind Singh Indraprastha University, Delhi",
    bio: "",
    image: "/speakers/Prof. Deeksha Katyal.jpg",
    category: "",
    featured: false,
    socials: {
      twitter: "#",
  ...
  },
  {
    ...
    role: "Head",
    company: "GCC Transformation Consulting, Zinnov",
    bio: "",
  ...
  },
  {
   ...
   {
    id: 28,
    name: "Dr. Komal Tripathi",
    role: "Professor",
    company: "IIT Roorkee",
    bio: "",
    image: "/speakers/Dr. Komal Tripathi.jpg",
    category: "",
    featured: false,
    socials: {
      twitter: "#",
  ...
  {
    id: 29,
    name: "Ms. Mansi Chaudhry",
    role: "Founder & Managing Partner",
    company: "The Frontiers Legal Patent Trademark & Design Attorney",
    bio: "",
    image: "/speakers/Ms. Mansi Chaudhry.jpg",
    category: "",
    featured: false,
    socials: {
      twitter: "#",
  ...
  {
    id: 32,
    name: "Prof. Nitash P. Balsara",
    role: "Professor",
    company: "University of California, Berkeley",
    bio: "",
    image: "/speakers/Prof. Nitash P. Balsara.jpg",
    category: "",
    featured: false,
    socials: {
      twitter: "#",
  ...
  {
    id: 33,
    name: "Prof. Neelkanth Nirmalkar",
    role: "Professor",
    company: "IIT Ropar",
    bio: "",
    image: "/speakers/Prof. Neelkanth Nirmalkar.jpg",
    category: "",
    featured: false,
    socials: {
      twitter: "#",
  ...
  },
  {
    ...
    role: "Professor",
    company: "University Institute of Chemical Technology, KBCNMU, Jalgaon",
    bio: "",
  ...
  {
    id: 65,
    name: "Dr. Venkant Sudheendra",
    role: " ",
    company: "TRDDC, TCS Pune",
    bio: "",
    image: "/speakers/Dr. Venkant Sudheendra.jpg",
    category: "",
    featured: false,
    socials: {
      twitter: "#",
