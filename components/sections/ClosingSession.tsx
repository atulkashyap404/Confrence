    ...
    <section id="welcome" className="py-24 bg-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col lg:flex-row items-center lg:items-start gap-10 max-w-6xl mx-auto"
        >
          ...
          <div className="w-full lg:w-1/2 text-left">
            <h2 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white mb-10 text-center lg:text-left">
