...
export default function HowToReachPage() {
  return (
    <section
      id="howtoreach"
      className="py-16 px-4 md:px-10 lg:px-20 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 overflow-hidden"
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        <motion.p
          className="inline-block mb-8 text-xl text-center px-4 "
          animate={{ x: ["60%", "-60%"] }}
          transition={{
            duration: 12,
            repeat: Infinity,
        ...
        >
          <span className="font-semibold">
            Pick-up and drop-off service from the airport and railway station
            will be arranged by the
          </span>{" "}
          <strong className="text-kesari shadow-lg ">TRIPS 2025 Team</strong>!
        </motion.p>

        {/* <motion.p
        className="inline-block mb-8 text-lg text-center"
        animate={{ x: ["100%", "-100%"] }}
        transition={{
          duration: 10,
          repeat: Infinity,
      ...
      >
        Pick-up and drop-off service from the airport and railway station will be arranged by the <strong>TRIPS 2025 Team</strong>!
      </motion.p> */}
          ...
          <div className="rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            <div className="p-6 text-left space-y-6">
              ...
              <div>
                ...
                <p>
                  Kanpur has a domestic airport with limited flight
                  connectivity, primarily serving cities like Delhi, Mumbai,
                  Bengaluru, and Hyderabad. While options may be fewer, it is
                  the most convenient mode of travel for those who find a
                  suitable direct flight.
                </p>
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    <strong>Distance:</strong> ~25 km
                  </li>
                  <li>
                  ...
                  <table className="min-w-full table-auto border border-collapse border-gray-300 dark:border-gray-600">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border px-4 py-2">IndiGo 6E5396</td>
                        <td className="border px-4 py-2">New Delhi (DEL)</td>
                        <td className="border px-4 py-2">14:14</td>
                      </tr>
                      <tr>
                        <td className="border px-4 py-2">2</td>
                        <td className="border px-4 py-2">IndiGo 6E824</td>
                        <td className="border px-4 py-2">Mumbai (BOM)</td>
                        <td className="border px-4 py-2">15:10</td>
                      </tr>
                      <tr>
                        <td className="border px-4 py-2">3</td>
                        <td className="border px-4 py-2">IndiGo 6E307</td>
                        <td className="border px-4 py-2">Bengaluru (BLR)</td>
                        <td className="border px-4 py-2">12:06</td>
                      </tr>
                      <tr>
                        <td className="border px-4 py-2">4</td>
                        <td className="border px-4 py-2">IndiGo 6E6817</td>
                        <td className="border px-4 py-2">Hyderabad (HYD)</td>
                        <td className="border px-4 py-2">10:53</td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table className="min-w-full table-auto border border-collapse border-gray-300 dark:border-gray-600">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border px-4 py-2">IndiGo 6E2192</td>
                        <td className="border px-4 py-2">New Delhi (DEL)</td>
                        <td className="border px-4 py-2">15:08</td>
                      </tr>
                      <tr>
                        <td className="border px-4 py-2">6</td>
                        <td className="border px-4 py-2">IndiGo 6E308</td>
                        <td className="border px-4 py-2">Bengaluru (BLR)</td>
                        <td className="border px-4 py-2">13:10</td>
                      </tr>
                      <tr>
                        <td className="border px-4 py-2">7</td>
                        <td className="border px-4 py-2">IndiGo 6E6819</td>
                        <td className="border px-4 py-2">Hyderabad (HYD)</td>
                        <td className="border px-4 py-2">11:30</td>
                      </tr>
                      <tr>
                        <td className="border px-4 py-2">8</td>
                        <td className="border px-4 py-2">IndiGo 6E827</td>
                        <td className="border px-4 py-2">Mumbai (BOM)</td>
                        <td className="border px-4 py-2">16:01</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    Major international hub with connections across India and
                    the world.
                  </li>
                  <li>
                    Take a connecting flight to Kanpur or Lucknow, or travel by
                    train to Kanpur.
                  </li>
                </ul>
              </div>
